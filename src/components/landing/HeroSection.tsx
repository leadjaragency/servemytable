...
const stats = [
  { target: 40, prefix: "-", suffix: "%", label: "Labor costs",    color: "text-[#FAF6ED]"  },
...
export default function HeroSection() {
  ...
  return (
    <section className="relative bg-[#0A0A0A] pt-20 pb-12 md:pt-28 md:pb-20 overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none" aria-hidden="true">
        ...
        <div
          className="animate-orb-drift absolute bottom-0 left-0 w-[400px] h-[400px] rounded-full bg-[#141414]/5 blur-3xl translate-y-1/4 -translate-x-1/4"
      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          ...
          >
            {/* Badge */}
            <motion.div
              className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full border border-[#2A2A2A] bg-[#131313] text-sm text-[#AD897E] mb-4 shadow-sm"
            ...
            <h1 className="font-display text-5xl sm:text-6xl lg:text-7xl text-[#FAF6ED] leading-none mb-5">
              <AnimatedText
            ...
            {/* Subheadline */}
            <motion.p
              className="text-base sm:text-lg text-[#AD897E] leading-relaxed mb-8 max-w-lg"
            ...
            >
              ...
              <motion.div variants={prefersReduced ? undefined : scaleIn(0.95)}>
                <a
                  href="#how-it-works"
                  className="inline-flex items-center gap-2 h-12 px-6 text-base font-medium rounded-xl border border-[#2A2A2A] text-[#FAF6ED] bg-[#131313]/70 hover:bg-[#131313] transition-colors"
                >
                  See How It Works
                </a>
              </motion.div>
            ...
            <div className="grid grid-cols-2 sm:flex sm:gap-8 gap-4 pt-5 border-t border-[#2A2A2A]">
              {stats.map((s, i) => (
                <motion.div
                  key={s.label}
                ...
                >
                  ...
                  <div className="text-xs text-[#AD897E] mt-0.5">{s.label}</div>
                </motion.div>
              ))}
            </div>
          </motion.div>
          ...
          >
            <div className="relative w-full max-w-[520px]">
              ...
              {/* Main photo */}
              <div className="relative rounded-2xl overflow-hidden shadow-2xl shadow-[#1B2A4A]/20 border border-[#2A2A2A]">
                <Image
              ...
              <div
                className="animate-float-bob absolute -bottom-4 left-4 sm:-left-4 bg-[#131313] rounded-2xl px-3 py-2.5 shadow-xl border border-[#2A2A2A] flex items-center gap-2.5"
              ...
              >
                ...
                <div>
                  <div className="font-display text-sm text-[#FAF6ED] leading-none">Zero App</div>
                  <div className="text-[10px] text-[#AD897E] mt-0.5">Just scan & order</div>
                </div>
              </div>

              {/* Floating badge — top right */}
              <div
                className="animate-float-bob absolute -top-4 right-4 sm:-right-4 bg-[#141414] rounded-2xl px-3 py-2.5 shadow-xl"
